...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="left_controller.yaml",
    ...
    print (str(PathJoinSubstitution([FindPackageShare(description_package), "urdf", description_file])))
    ...
    io_and_status_controller_spawner = Node(
        package="controller_manager",
        executable="spawner.py",
        arguments=["io_and_status_controller", "-c", "/left/controller_manager"],
    )
    ...
    robot_controller_spawner = Node(
        package="controller_manager",
        executable="spawner.py",
        arguments=[robot_controller, "-c", "/left/controller_manager"],
    )
    ...
    print ("left namespace instantiated")

    return LaunchDescription(declared_arguments + nodes_to_start)
    #return LaunchDescription([left_launch_namespace])
