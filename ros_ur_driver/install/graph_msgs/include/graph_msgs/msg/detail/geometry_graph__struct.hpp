...
struct GeometryGraph_
{
  ...
  _nodes_type nodes;
  using _edges_type =
    std::vector<graph_msgs::msg::Edges_<ContainerAllocator>, typename ContainerAllocator::template rebind<graph_msgs::msg::Edges_<ContainerAllocator>>::other>;
  _edges_type edges;
  ...
  Type & set__edges(
    const std::vector<graph_msgs::msg::Edges_<ContainerAllocator>, typename ContainerAllocator::template rebind<graph_msgs::msg::Edges_<ContainerAllocator>>::other> & _arg)
  {
    this->edges = _arg;
    return *this;
  }
