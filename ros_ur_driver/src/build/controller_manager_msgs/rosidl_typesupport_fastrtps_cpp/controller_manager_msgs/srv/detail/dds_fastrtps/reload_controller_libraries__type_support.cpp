...
{
  return max_serialized_size_ReloadControllerLibraries_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_ReloadControllerLibraries_Response(full_bounded, 0);
}
