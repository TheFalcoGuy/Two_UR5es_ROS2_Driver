...
static size_t _ReloadControllerLibraries_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__ReloadControllerLibraries_Request(
    full_bounded, 0);
}
...
static size_t _ReloadControllerLibraries_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__ReloadControllerLibraries_Response(
    full_bounded, 0);
}
