...
static size_t _ListHardwareInterfaces_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__ListHardwareInterfaces_Request(
    full_bounded, 0);
}
...
static size_t _ListHardwareInterfaces_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__ListHardwareInterfaces_Response(
    full_bounded, 0);
}
