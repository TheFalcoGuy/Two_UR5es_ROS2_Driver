...
static size_t _UnloadController_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__UnloadController_Request(
    full_bounded, 0);
}
...
static size_t _UnloadController_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__UnloadController_Response(
    full_bounded, 0);
}
