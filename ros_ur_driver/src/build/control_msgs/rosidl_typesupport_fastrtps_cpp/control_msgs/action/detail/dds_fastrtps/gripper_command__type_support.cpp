...
static size_t _GripperCommand_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_GripperCommand_Goal(full_bounded, 0);
}
...
static size_t _GripperCommand_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_GripperCommand_Result(full_bounded, 0);
}
...
static size_t _GripperCommand_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_GripperCommand_Feedback(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const control_msgs::action::GripperCommand_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
static size_t _GripperCommand_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_GripperCommand_SendGoal_Request(full_bounded, 0);
}
...
static size_t _GripperCommand_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_GripperCommand_SendGoal_Response(full_bounded, 0);
}
...
static size_t _GripperCommand_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_GripperCommand_GetResult_Request(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const control_msgs::action::GripperCommand_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
static size_t _GripperCommand_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_GripperCommand_GetResult_Response(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const control_msgs::action::GripperCommand_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
static size_t _GripperCommand_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_GripperCommand_FeedbackMessage(full_bounded, 0);
}
