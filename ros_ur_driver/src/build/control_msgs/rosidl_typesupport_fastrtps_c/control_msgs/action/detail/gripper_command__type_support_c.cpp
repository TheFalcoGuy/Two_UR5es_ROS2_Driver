...
{
  return max_serialized_size_control_msgs__action__GripperCommand_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__GripperCommand_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__GripperCommand_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__GripperCommand_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__GripperCommand_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__GripperCommand_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__GripperCommand_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_control_msgs__action__GripperCommand_FeedbackMessage(
    full_bounded, 0);
}
