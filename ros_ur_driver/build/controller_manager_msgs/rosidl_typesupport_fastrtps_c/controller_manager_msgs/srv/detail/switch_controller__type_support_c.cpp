...
#include "rosidl_runtime_c/string.h"  // start_controllers, stop_controllers
#include "rosidl_runtime_c/string_functions.h"  // start_controllers, stop_controllers
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: start_controllers
  {
    ...
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->start_controllers, size)) {
      return "failed to create array for field 'start_controllers'";
    }
    auto array_ptr = ros_message->start_controllers.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
  ...
  // Field name: stop_controllers
  {
    ...
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->stop_controllers, size)) {
      return "failed to create array for field 'stop_controllers'";
    }
    auto array_ptr = ros_message->stop_controllers.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
static size_t _SwitchController_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__SwitchController_Request(
    full_bounded, 0);
}
...
static size_t _SwitchController_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_controller_manager_msgs__srv__SwitchController_Response(
    full_bounded, 0);
}
