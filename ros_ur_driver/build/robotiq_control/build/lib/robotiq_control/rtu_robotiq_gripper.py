...
class RtuRobotiqGripper( mm.Instrument):
    ...
    def get_current_position(self):
        return self.getPositionCurrent()[0]
...
#     grip=RtuRobotiqGripper("/dev/ttyUSB1", slaveaddress=9)
#     print ("Hello")
#     grip.resetActivate()
#     grip.reset()
#     #grip.printInfo()
...
#     while True:
#         print("Current position", grip.getPositionmm())
#         print("Current position bits", grip.getPositionCurrent())
