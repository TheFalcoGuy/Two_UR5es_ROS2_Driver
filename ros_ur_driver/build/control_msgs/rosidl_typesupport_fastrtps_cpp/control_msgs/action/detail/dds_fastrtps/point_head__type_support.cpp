...
static size_t _PointHead_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_PointHead_Goal(full_bounded, 0);
}
...
static size_t _PointHead_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_PointHead_Result(full_bounded, 0);
}
...
static size_t _PointHead_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_PointHead_Feedback(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const control_msgs::action::PointHead_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
static size_t _PointHead_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_PointHead_SendGoal_Request(full_bounded, 0);
}
...
static size_t _PointHead_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_PointHead_SendGoal_Response(full_bounded, 0);
}
...
static size_t _PointHead_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_PointHead_GetResult_Request(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const control_msgs::action::PointHead_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
static size_t _PointHead_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_PointHead_GetResult_Response(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const control_msgs::action::PointHead_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
static size_t _PointHead_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_PointHead_FeedbackMessage(full_bounded, 0);
}
