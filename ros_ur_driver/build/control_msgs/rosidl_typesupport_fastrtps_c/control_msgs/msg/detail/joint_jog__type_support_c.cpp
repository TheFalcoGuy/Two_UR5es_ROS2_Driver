  ...
  void * untyped_ros_message)
{
  ...
  // Field name: displacements
  {
    ...
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->displacements, size)) {
      return "failed to create array for field 'displacements'";
    }
    auto array_ptr = ros_message->displacements.data;
...
static size_t _JointJog__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_control_msgs__msg__JointJog(
    full_bounded, 0);
}
