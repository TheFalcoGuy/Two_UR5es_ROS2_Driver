...
static const _MoveArm_Request_type_support_symbol_names_t _MoveArm_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, move_arm_interfaces, srv, MoveArm_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, move_arm_interfaces, srv, MoveArm_Request)),
  }
};
...
{
  return &::move_arm_interfaces::srv::rosidl_typesupport_cpp::MoveArm_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, move_arm_interfaces, srv, MoveArm_Request)() {
  return get_message_type_support_handle<move_arm_interfaces::srv::MoveArm_Request>();
}
...
static const _MoveArm_Response_type_support_symbol_names_t _MoveArm_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, move_arm_interfaces, srv, MoveArm_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, move_arm_interfaces, srv, MoveArm_Response)),
  }
};
...
{
  return &::move_arm_interfaces::srv::rosidl_typesupport_cpp::MoveArm_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, move_arm_interfaces, srv, MoveArm_Response)() {
  return get_message_type_support_handle<move_arm_interfaces::srv::MoveArm_Response>();
}
...
static const _MoveArm_type_support_symbol_names_t _MoveArm_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, move_arm_interfaces, srv, MoveArm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, move_arm_interfaces, srv, MoveArm)),
  }
};
...
{
  return &::move_arm_interfaces::srv::rosidl_typesupport_cpp::MoveArm_service_type_support_handle;
}
