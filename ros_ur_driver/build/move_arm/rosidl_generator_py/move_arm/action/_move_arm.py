...
class Metaclass_MoveArm_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('move_arm')
        except ImportError:
            import logging
            import traceback
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'joint_angles' field must be a set or sequence and each value of type 'float'"
...
class Metaclass_MoveArm_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from move_arm.action import MoveArm
...
class MoveArm_SendGoal_Request(metaclass=Metaclass_MoveArm_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'move_arm/MoveArm_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['move_arm', 'action'], 'MoveArm_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from move_arm.action._move_arm import MoveArm_Goal
...
class Metaclass_MoveArm_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'move_arm.action.MoveArm_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from move_arm.action import _move_arm
...
class MoveArm_SendGoal(metaclass=Metaclass_MoveArm_SendGoal):
    from move_arm.action._move_arm import MoveArm_SendGoal_Request as Request
    from move_arm.action._move_arm import MoveArm_SendGoal_Response as Response
...
class MoveArm_GetResult_Response(metaclass=Metaclass_MoveArm_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'move_arm/MoveArm_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['move_arm', 'action'], 'MoveArm_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from move_arm.action._move_arm import MoveArm_Result
...
class Metaclass_MoveArm_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'move_arm.action.MoveArm_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveArm_GetResult(metaclass=Metaclass_MoveArm_GetResult):
    from move_arm.action._move_arm import MoveArm_GetResult_Request as Request
    from move_arm.action._move_arm import MoveArm_GetResult_Response as Response
...
class Metaclass_MoveArm_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'move_arm.action.MoveArm_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveArm_FeedbackMessage(metaclass=Metaclass_MoveArm_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'move_arm/MoveArm_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['move_arm', 'action'], 'MoveArm_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from move_arm.action._move_arm import MoveArm_Feedback
...
class MoveArm(metaclass=Metaclass_MoveArm):
    ...
    from move_arm.action._move_arm import MoveArm_Goal as Goal
    # The result message defined in the action definition.
    from move_arm.action._move_arm import MoveArm_Result as Result
    # The feedback message defined in the action definition.
    from move_arm.action._move_arm import MoveArm_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from move_arm.action._move_arm import MoveArm_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from move_arm.action._move_arm import MoveArm_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from move_arm.action._move_arm import MoveArm_FeedbackMessage as FeedbackMessage
